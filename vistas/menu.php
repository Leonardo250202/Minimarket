      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <!-- <li><a href="productos.php"><span class="glyphicon glyphicon-list-alt"></span> Productos</a>
            </li> -->
            ...
            <!-- <li><a href="ventas.php"><span class="glyphicon glyphicon-usd"></span> Vender Articulo</a></li>  -->
